...
def add_changelog(to_be_migrated):
    ...
    for module_name in to_be_migrated:
        msg = f"""{module_name} - The module has been migrated from the ``community.aws`` collection. Playbooks using the Fully Qualified Collection Name for this module should be updated to use ``amazon.aws.{module_name}``."""
