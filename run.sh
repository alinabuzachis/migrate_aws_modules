...
FILTER_BRANCH_SQUELCH_WARNING=1 git filter-branch -f --msg-filter 'python3 /Users/alinabuzachis/dev/migrate_aws_modules/rewrite.py'
...
python3 /Users/alinabuzachis/dev/migrate_aws_modules/regenerare_runtime.py ${c_a_path} ${a_a_path} $module_to_migrate
...
sleep 10
python /Users/alinabuzachis/dev/migrate_aws_modules/open_pr.py $module_to_migrate promote_$module_to_migrate